...
export class RegisterProductComponent implements OnInit {
  ...
  constructor(private _snackBar: MatSnackBar,
    ...
    this.productForm = new FormGroup({
      ...
      pcoin: new FormControl("", [Validators.required,Validators.pattern('[(0-9)+.?(0-9)*]+')]),
...
//            clearInterval(progressInterval);
 ...
 get Pcoin(): FormControl{
  return this.productForm.get('pcoin')as FormControl;
}
  onClickSubmitForm() {
    ...
    if (!this.productForm.invalid) {
      ...
      this.registerservice.addProduct1(this.productObj).subscribe(data =>
